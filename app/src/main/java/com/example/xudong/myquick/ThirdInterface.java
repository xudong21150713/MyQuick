...
public class ThirdInterface extends AppCompatActivity {
    ...
    @BindView(R.id.activtyImage_outcome)
    ImageView icon;

    @BindView(R.id.activities_outcome)
    TextView text;

    @BindView(R.id.tb_note_date_outcome)
    TextView date;
    ...
    @OnClick(R.id.activity_outcome)
    public void select(){
        dialog = new Dialog(this, R.style.BottomDialog);
        View contentView = LayoutInflater.from(this).inflate(R.layout.activity_dialog_content, null);
    ...
    @OnClick(R.id.date_outcome)    //设置日期
    public void date(){
